...
const $checkbox = document.querySelector("#delayed");
const $hiddenValue = document.querySelector("input[type='hidden']");
...
function resetValidationStyle() {
    ...
    $hiddenValue.name = "delayed";
    $checkbox.name = "delayed";
}
